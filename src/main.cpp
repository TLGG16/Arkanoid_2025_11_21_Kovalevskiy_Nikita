...
int main(int, char**)
{
    ...
    GLFWwindow* window = glfwCreateWindow(1200, 900, "Arkanoid Test", NULL, NULL);
    if (window == NULL)
        return 1;
    ...
    while (!glfwWindowShouldClose(window))
    {
...

        {
            ...
            ImGui::Text("Score: %d", arkanoid_settings.score);
        ...
        // update settings window
        {
            ...
            ImGui::SliderFloat("Carriage speed", &arkanoid_settings.carriage_speed, ArkanoidSettings::carriage_width_min, arkanoid_settings.world_size.x);
