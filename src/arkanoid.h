...
struct ArkanoidSettings
{
    ...
    static constexpr float bricks_columns_padding_min = 1.0f;
    static constexpr float bricks_columns_padding_max = 10.0f;
    static constexpr float bricks_rows_padding_min = 1.0f;
    ...
    float carriage_width = 400.0f;
    float carriage_speed = 1000.0f;
    bool  godemode = 0;

    static int inline score = 0;
};
